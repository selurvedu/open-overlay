...
COMMON_DEPEND="
	...
	>=gnome-extra/cinnamon-menus-2.6:0[introspection]
	>=gnome-extra/cjs-2.6
	...
	>=x11-wm/muffin-2.6[introspection]
	${PYTHON_DEPS}
	networkmanager? (
...
RDEPEND="${COMMON_DEPEND}
	...
	>=gnome-extra/cinnamon-session-2.6
	>=gnome-extra/cinnamon-settings-daemon-2.6
	...
	>=gnome-extra/cinnamon-control-center-2.6
	>=gnome-extra/cinnamon-screensaver-2.6
	...
	nls? ( >=gnome-extra/cinnamon-translations-2.6 )
"
