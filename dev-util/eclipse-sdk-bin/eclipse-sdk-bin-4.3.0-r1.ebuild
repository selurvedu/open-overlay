...
SRC_URI="
	amd64? ( http://mirror.tspu.ru/eclipse/technology/epp/downloads/release/${RNAME}/${SR}/eclipse-java-${RNAME}-SR2-Java8-linux-gtk-x86_64.tar.gz -> eclipse-java-${RNAME}-${SR}-linux-gtk-x86_64-${PV}.tar.gz )
	x86? ( http://mirror.tspu.ru/eclipse/technology/epp/downloads/release/${RNAME}/${SR}/eclipse-java-${RNAME}-SR2-Java8-linux-gtk.tar.gz -> eclipse-java-${RNAME}-${SR}-linux-gtk-${PV}.tar.gz )"
