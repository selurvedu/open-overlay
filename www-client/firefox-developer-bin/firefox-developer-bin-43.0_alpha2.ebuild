...
MOZ_HTTP_URI="http://archive.mozilla.org/pub/mozilla.org/firefox/nightly/2015/10/2015-10-13-00-40-18-mozilla-aurora/"
...
SRC_URI="${SRC_URI}
	amd64? ( ${MOZ_HTTP_URI}/firefox-43.0a2.en-US.linux-x86_64.tar.bz2 -> ${P}-x86_64.tar.bz2 )
        x86? ( ${MOZ_HTTP_URI}/firefox-43.0a2.en-US.linux-i686.tar.bz2  -> ${P}-i686.tar.bz2 )"
