...
MOZ_FTP_URI="ftp://ftp.mozilla.org/pub/mozilla.org/firefox/nightly/2015/04/2015-04-08-mozilla-aurora-debug//"
...
SRC_URI="${SRC_URI}
	amd64? ( ${MOZ_FTP_URI}/firefox-39.0a2.en-US.debug-linux-x86_64.tar.bz2 -> ${P}-x86_64.tar.bz2 )
        x86? ( ${MOZ_FTP_URI}/firefox-39.0a2.en-US.debug-linux-i686.tar.bz2  -> ${P}-i686.tar.bz2 )"
