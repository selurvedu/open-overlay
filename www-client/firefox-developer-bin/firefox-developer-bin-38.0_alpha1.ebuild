...
MOZ_FTP_URI="ftp://ftp.mozilla.org/pub/mozilla.org/firefox/nightly/2015/02/2015-02-10-mozilla-inbound-debug//"
...
SRC_URI="${SRC_URI}
	amd64? ( ${MOZ_FTP_URI}/firefox-38.0a1.en-US.debug-linux-x86_64.tar.bz2 -> ${P}-x86_64.tar.bz2 )
        x86? ( ${MOZ_FTP_URI}/firefox-38.0a1.en-US.debug-linux-i686.tar.bz2  -> ${P}-i686.tar.bz2 )"
