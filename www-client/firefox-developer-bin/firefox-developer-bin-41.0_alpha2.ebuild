...
SRC_URI="${SRC_URI}
	amd64? ( ${MOZ_FTP_URI}/firefox-41.0a2.en-US.debug-linux-x86_64.tar.bz2 -> ${P}-x86_64.tar.bz2 )
        x86? ( ${MOZ_FTP_URI}/firefox-41.0a2.en-US.debug-linux-i686.tar.bz2  -> ${P}-i686.tar.bz2 )"
