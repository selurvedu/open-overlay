...
RDEPEND="
	>=mate-base/mate-desktop-1.11:0[gtk3?]
	>=mate-base/mate-menus-1.11:0
	...
	base? (
		...
		>=mate-base/mate-control-center-1.11:0[gtk3?]
		>=mate-extra/mate-media-1.11:0
		>=x11-misc/mozo-1.10:0
		>=x11-terms/mate-terminal-1.11:0[gtk3?]
	)
	bluetooth? ( net-wireless/blueman:0 )
	themes? (
		>=x11-themes/mate-backgrounds-1.10:0
		>=x11-themes/mate-icon-theme-1.11:0
		>=x11-themes/mate-themes-1.10:0
	)
	extras? (
		>=app-arch/engrampa-1.11:0[gtk3?]
		>=app-editors/pluma-1.11:0[gtk3?]
		>=app-text/atril-1.11:0[gtk3?]
		!gtk3? ( >=mate-extra/mate-calc-1.8:0 )
		gtk3? ( sci-calculators/galculator )
                >=mate-extra/mate-power-manager-1.11:0[gtk3?]
		>=mate-extra/mate-screensaver-1.11:0
		>=mate-extra/mate-system-monitor-1.11:0[gtk3?]
		>=mate-extra/mate-utils-1.11:0
		>=media-gfx/eom-1.11:0[gtk3?]
	)
"
...
#	elog ""
	...
	elog "http://forums.mate-desktop.org/viewtopic.php?f=16&t=1650"
        elog ""
        elog "For user guide information: emerge mate-user-guide-1.11.0"
        elog ""
        elog ""
